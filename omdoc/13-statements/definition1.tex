...
\begin{module}[id=foo]
  ...
  \begin{definition}
    ...
    This \defii[name=newconc]{new}{one} is defined in terms of the existing \mtrefi[?conc]{one}.
  \end{definition}
  ...
  \begin{definition}
    ...
    \mtrefi[?conc]{one} and the \mtrefii[?newconc]{new}{one}.
  \end{definition}
  ...
  \begin{definition}
    ...
    \mtrefiii[?vnconc]{very}{new}{one}.
  \end{definition}
  We can also reference the \trefiv{absolutely}{completely}{new}{concept} directly or the
 \mtrefiv[?acnconc]{absolutely}{completely}{new}{one} by name.
\end{module}
\end{document}
%%% Local Variables:
%%% mode: latex
